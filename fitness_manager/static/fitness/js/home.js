...
window.addEventListener("load" , function (){
    ...
    //$(document).on("click", "#watch_start", function(){ menu_pre_start(this); });
...
function menu_start(){
    ...
    $(document).on("click", "#timer_pause" , function(){ 
        //TODO:ここでif文でチェックできるようにしたい。←isRunning()で判定できるっぽい
        //https://stackoverflow.com/questions/58050820/how-to-know-if-easytimer-is-stopped-or-not
